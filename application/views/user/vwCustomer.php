			...
			<div class="col-12">
				<div class="box-content">
					...
					<div class="float-right">
						<a class="btn btn-sm btn-default" href="<?php echo base_url('user/common/import_excel/customer');?>"><i class="fa fa-upload"></i> Import Customers</a>
						<a class="btn btn-sm btn-primary" href="<?php echo base_url('user/customer/form');?>"><i class="ico fa fa-plus"></i>Add Customer</a>
					</div>
					</h4>
					<hr>
							...
							<tr role="row" class="<?=$tr_class?>">
								...
								<td class="text-center">
									<div class="btn-group" role="group" aria-label="Basic example">
										<button type="button" class="btn btn-info btn-xs waves-effect waves-light" data-toggle="tooltip" title="Edit"  onclick="location.href='<?php echo base_url('user/customer/form/').$db_value->id;?>'"><i class="ico fa fa-edit"></i></button>
