		...
		<div class="row small-spacing ">
			...
			<div class="col-lg-12">
				<div class="box-content">
					...
					<form action="<?php echo base_url('user/customer/form/').$id;?>" id="user_form" method="POST" enctype="multipart/form-data" autocomplete="off">
					<!-- /.box-title -->
					<div class="row">
						...
						<div class="form-group pt-3 padding-20 col-lg-6">
							<label for="gst_certificate">Upload Company GST Certificate (Remarks- If not applicable, then submit Declaration Form)</label><br>
							<input type="file" id="gst_certificate" name="gst_certificate[]" multiple>
						...
						<div class="form-group pt-3 padding-20 col-lg-6">
							...
							<input type="file" id="pan_cart_image" name="pan_cart_image[]" multiple>
