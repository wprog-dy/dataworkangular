					...
					<table id="example" class="table table-striped table-bordered display dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
						...
						?>
							<tr role="row" class="<?=$tr_class?>">
								...
								<td><a href="<?= base_url('user/enquiries/vendorreplydetails/'.$db_value->enquiry_id); ?>"><?= ucwords($db_value->first_name.' '.$db_value->last_name); ?></a></td>
								...
								<td><a href="<?= base_url('user/enquiries/vendorreplydetails/'.$db_value->enquiry_id); ?>"><?= $db_value->reference_id; ?></a></td>
								<td><a href="<?= base_url('user/enquiries/vendorreplydetails/'.$db_value->enquiry_id); ?>"><?= $db_value->replaied_date; ?></a></td>
								<td><a href="<?= base_url('user/enquiries/vendorreplydetails/'.$db_value->enquiry_id); ?>"><?= $db_value->equiry_status; ?></a></td>
								</a>
							</tr>
						<?php } ?>
						</tbody>
